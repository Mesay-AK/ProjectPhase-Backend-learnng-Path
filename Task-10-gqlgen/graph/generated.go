...
type ComplexityRoot struct {
	Mutation struct {
		...
		UpdateTask func(childComplexity int, id string, title *string, description *string, completed *bool) int
	}
...
type MutationResolver interface {
	...
	UpdateTask(ctx context.Context, id string, title *string, description *string, completed *bool) (*model.Task, error)
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Mutation.updateTask":
		...
		return e.complexity.Mutation.UpdateTask(childComplexity, args["id"].(string), args["title"].(*string), args["description"].(*string), args["completed"].(*bool)), true
...
func (ec *executionContext) field_Mutation_addTask_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	var err error
	args := map[string]any{}
	arg0, err := ec.field_Mutation_addTask_argsTitle(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["title"] = arg0
	arg1, err := ec.field_Mutation_addTask_argsDescription(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
...
func (ec *executionContext) field_Mutation_addTask_argsTitle(
	ctx context.Context,
...
func (ec *executionContext) field_Mutation_addTask_argsDescription(
	ctx context.Context,
	rawArgs map[string]any,
) (*string, error) {
...
func (ec *executionContext) field_Mutation_updateTask_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	arg3, err := ec.field_Mutation_updateTask_argsCompleted(ctx, rawArgs)
	if err != nil {
		return nil, err
	}
	args["completed"] = arg3
...
func (ec *executionContext) field_Mutation_updateTask_argsCompleted(
	ctx context.Context,
	rawArgs map[string]any,
) (*bool, error) {
...
func (ec *executionContext) _Mutation_updateTask(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (any, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().UpdateTask(rctx, fc.Args["id"].(string), fc.Args["title"].(*string), fc.Args["description"].(*string), fc.Args["completed"].(*bool))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
